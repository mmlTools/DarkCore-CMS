			...
			<div id='lastnews'>
				...
				<div class='newsthumb'>
					<div class='newsthumbicon'>
						<img src="<?php echo get_avatar_byid($data_news->last_topic_index['autor']);?>" alt="<?php echo $data_news->last_topic_index['title'];?>" width='100%' height='100%'/>
					</div>
						...
						<div class='newsthumbbutton'>
							<div class='thb-left'>
								...
								<a href="../player?id=<?php echo $data_news->last_topic_index['autor']; ?>">
									<label style='font-size:14px !important;color:#
										<?php echo namecolor(get_rank_byid($data_news->last_topic_index['autor']),get_vip_byid($data_news->last_topic_index['autor'])); ?>;'>
										<?php echo ucfirst(strtolower(get_username_byid($data_news->last_topic_index['autor']))); 
										?>											
									</label>
								</a>
							...
							<div class="thb-right">
								<a href='board/topic?id=<?php echo $data_news->last_topic_index['id']; ?>&page=1/<?php echo urlencode($data_news->last_topic_index['title']); ?>' class='lastnews-right-text'>Read All...</a>
							</div>
						</div>
					</div>
				</div>
        ...
        <div id='index-content-right'>
            <div class='acclogin-info'>
                ...
                <div class='loggedas'>
					...
					} else { $user_account->construct(ucfirst($user_prw));
						echo "
